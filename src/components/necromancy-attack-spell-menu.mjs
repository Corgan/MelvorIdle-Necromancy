...
export class NecromancyAttackSpellMenuElement extends HTMLElement {
    constructor() {
        super();
        this.requirements = [];
        this.spells = [];
        ...
        this._content.append(getTemplateNode('necromancy-attack-spell-menu-template'));
    ...
    init() {
        this.setSpells(game.necromancy.spells.allObjects.sort((a,b)=>a.level - b.level));
    }
    getToggleCallback(spell) {
        return ()=>game.necromancy.selectAttackSpell(spell);
    }
...
window.customElements.define('necromancy-attack-spell-menu', NecromancyAttackSpellMenuElement);