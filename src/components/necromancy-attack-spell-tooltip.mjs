...
export class NecromancyAttackSpellTooltipElement extends HTMLElement {
    constructor() {
        super();
        this._content = new DocumentFragment();
        this._content.append(getTemplateNode('necromancy-attack-spell-tooltip-template'));
...
window.customElements.define('necromancy-attack-spell-tooltip', NecromancyAttackSpellTooltipElement);